% Supplementary Information body. Input by main.tex after the bibliography, so its
% citations and cross-references resolve against the main document's single .aux.
