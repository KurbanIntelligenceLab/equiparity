...
The same rotation/improper-operation probe from `vendor/hotpp/probe_hotpp.py` was re-run directly on periodic crystals (cell and positions co-rotated), rather than only on the free-cluster geometry:
