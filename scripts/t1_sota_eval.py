"""T1: evaluate released GMTNet / CEITNet piezoelectric checkpoints on our OOD structures.
...
Must be run with the tier1 python:
    third_party/venvs/tier1/bin/python scripts/t1_sota_eval.py --model gmtnet --toy
    third_party/venvs/tier1/bin/python scripts/t1_sota_eval.py --model gmtnet
    third_party/venvs/tier1/bin/python scripts/t1_sota_eval.py --model ceitnet --toy
    third_party/venvs/tier1/bin/python scripts/t1_sota_eval.py --model ceitnet
...
OUT_DIR = REPO / "results/t1"
SUMMARY_PATH = REPO / "results/t1_sota_predictors.json"
