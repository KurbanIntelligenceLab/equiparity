"""T0-1 -- train/eval contamination check for the centrosymmetric evaluation population.
...
identifies the point groups of the zero-norm training rows with spglib.
    ...
    uv run --extra nequip python scripts/t0_contamination.py
"""
...
OUT_JSON = REPO / "results" / "t0_contamination.json"
OUT_MD = REPO / "docs" / "results" / "t0_contamination.md"
...
def _render(r: dict) -> None:
    lines = [
        "# T0-1 — train/eval contamination check",
        "",
