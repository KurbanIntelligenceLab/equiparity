...
Reproduces the parity-toggle finding (written up in the Supplementary Information, Supplementary
Note "Prevalence audit of released architectures"; the original checkpoint note is retired; git
show a3342ea:docs/reports/checkpoint1_offcycle_parity_toggle.md): flipping NequIP's ``parity``
boolean does NOT produce a parity-violating SO(3) model, while relabelling the edge spherical
harmonics (and hidden features) as all-even does.
...
Run: ``uv run --extra nequip python scripts/experiments/parity_toggle_probe.py``
