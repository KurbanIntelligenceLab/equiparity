...
Builds both arms via the raw-irreps route and classifies each with the reflection/rotation probe.
Prints a result table with parameter counts per arm.

Run: ``uv run --extra nequip python scripts/experiments/parity_audit.py``
"""
