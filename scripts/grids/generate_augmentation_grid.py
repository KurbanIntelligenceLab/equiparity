"""Expand the augmentation grid: SO(3) arms only, 4 cores x 3 seeds = 12 runs.
...
def main() -> None:
    ...
    for core in CORES:
        for seed in SEEDS:
            ...
            runs[PROFILE[core]].append(f"configs/augmentation/{name}")
