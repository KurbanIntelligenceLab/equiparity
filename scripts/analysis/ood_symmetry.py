...
Requires spglib, i.e. run under a model profile:
    ...
    uv run --extra nequip python scripts/analysis/ood_symmetry.py

Writes results/ood_symmetry.json and docs/results/ood_symmetry.md.
"""
...
OUT_MD = ROOT / "docs" / "results" / "ood_symmetry.md"
...
def _raw_o3_flagged() -> set[int]:
    ...
    from aggregate_grid import SEEDS, load_vectors
...
def _markdown(report: dict) -> str:
    ...
    lines = [
        "# Symmetry audit of the OOD set",
        "",
        "Generated by `scripts/analysis/ood_symmetry.py`. The OOD set was selected with spglib "
