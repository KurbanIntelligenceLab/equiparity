...
Reads the extracted ``dsgdb9nsd`` .xyz files, excludes the 3,054 uncharacterized molecules, parses
each into a validated record, and writes:
...
Run: ``uv run python scripts/data/prepare_qm9.py``
"""
...
def _write_dataset_manifest(n_kept: int) -> None:
    manifest = DatasetManifest(
        ...
        query="scripts/data/prepare_qm9.py; exclude 3054 uncharacterized (figshare 3195404)",
