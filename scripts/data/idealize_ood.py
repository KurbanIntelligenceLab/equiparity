...
symmetric geometries — otherwise an O(3)-exact model with a sensitive (tensor-product) head
reports a spurious nonzero response to that coordinate noise (observed: clifford false-flag 0.43
on raw vs ~0 on idealized). Idealizing snaps coordinates onto the space group; linear-head models
...
Run: uv run --extra data python scripts/data/idealize_ood.py
"""
