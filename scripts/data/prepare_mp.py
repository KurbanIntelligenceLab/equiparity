...
Requires MP_TOKEN in .env. Run: ``uv run python scripts/data/prepare_mp.py
[elastic|piezo|ood|all]``
"""
...
def _write_manifest(
    ...
    manifest = DatasetManifest(
        ...
        query="scripts/data/prepare_mp.py",
...
def prepare_ood(mpr) -> None:
    ...
    # geometries onto their exact space group before use: `python scripts/data/idealize_ood.py`.
    _write_manifest(
